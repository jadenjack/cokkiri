...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.mousybusiness.flutter_iot_wifi.FlutterIotWifiPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_iot_wifi, com.mousybusiness.flutter_iot_wifi.FlutterIotWifiPlugin", e);
    }
    try {
